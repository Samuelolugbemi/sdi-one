...
export default async function Page() {
  ...
  return <AppShell>
    <PageHeader title="Geotab Configuration" description="Telematics connector for GPS, status, faults, trips and utilization." actions={<Link className="btn btn-primary" href="/dashboard/integration-platform/connectors/geotab">Connector Overview</Link>} />
