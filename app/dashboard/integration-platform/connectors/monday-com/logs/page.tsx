...
export default async function Page() {
  ...
  return <AppShell>
    <PageHeader title="Monday.com Logs" description="Project planning connector for boards, items, subitems, dependencies and job planning synchronization." actions={<Link className="btn btn-primary" href="/dashboard/planning">Project Planning</Link>} />
