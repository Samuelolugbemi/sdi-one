...
export default async function Page() {
  ...
  return <AppShell>
    <PageHeader title="Ford Pro Telematics" description="OEM fleet connector for vehicles, odometer, location and diagnostics." actions={<Link className="btn btn-primary" href="/dashboard/integration-platform/connectors/ford-pro">Connector Overview</Link>} />
